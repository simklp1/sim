  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Form Edit Penanggung Jawab</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br>
            <?php foreach ($pj as $p) { ?>
              <form class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/staff/update_data_pj'; ?> " method="post" enctype="multipart/form-data" role="form">
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Kode Pemilik<span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="hidden" name="id" value="<?php echo $p->id ?>">
                    <input type="text" required="required" name="kode" class="form-control col-md-7 col-xs-12" value="<?php echo $p->kode ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea type="text" name="deskripsi" class="form-control col-md-7 col-xs-12" required="required"><?php echo $p->deskripsi ?></textarea>
                  </div>
                </div>

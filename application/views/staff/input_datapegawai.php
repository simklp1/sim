            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" action="<?php echo base_url('index.php/Staff/tambah_aksi_pegawai') ?>" method="post" enctype="multipart/form-data" role="form" >
                      ...
                      <div class="ln_solid"></div>
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <a type="button" href="<?=base_url('index.php/Staff/tampil_pegawai'); ?> " class="btn btn-round btn-warning">Kembali</a>
                          </div>
                        </div>
                    </form>
                  </div>

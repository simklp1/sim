            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" action="<?php echo base_url('index.php/Staff/tambah_aksi_pensiun') ?>" method="post" enctype="multipart/form-data" role="form" >

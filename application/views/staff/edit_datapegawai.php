        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php foreach ($pegawai as $p) { ?>
              <form class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/Staff/update_data_pegawai'; ?> " method="post" enctype="multipart/form-data" role="form">

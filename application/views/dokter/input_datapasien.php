    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br>
            <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" action="<?php echo base_url(). 'index.php/Dokter/tambah_aksi_pasien'; ?> " method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Nomor BPJS
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="no_bpjs" class="date-picker form-control col-md-7 col-xs-12" type="text" name="no_bpjs">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  ...
                  <a type="button" href="<?=base_url('index.php/DOkter/tampil_pasien'); ?> " class="btn btn-round btn-warning">Kembali</a>
                </div>
              </div>

        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php foreach ($pasien as $p) { ?>
              <form class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/Dokter/update_data_pasien'; ?> " method="post" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="no_bpjs" class="form-control col-md-7 col-xs-12" value="<?php echo $p->no_bpjs ?>" >
                  </div>
                </div>
                <div class="form-group">

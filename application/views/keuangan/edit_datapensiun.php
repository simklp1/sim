        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php foreach ($pensiun as $p) { ?>
              <form class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/Keuangan/update_data_pensiun'; ?> " method="post" enctype="multipart/form-data" role="form">

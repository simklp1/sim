          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Input Data Spesialis</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" action="<?php echo base_url('index.php/admin/tambah_aksi_spesialis') ?>" method="post" enctype="multipart/form-data" role="form" >
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text"  name="spesialis" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
